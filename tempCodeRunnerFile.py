...
FFMPEG_BIN = os.environ.get("FFMPEG_BIN", r"c:\Users\Asus\Downloads\video downloader")  # adjust if needed
MAX_WORKERS = 3
...
def download_job(task_id, url, quality):
    ...
    try:
        ...
        # cleanup is delayed until user downloads or we evict; keep file for a while
        pass
